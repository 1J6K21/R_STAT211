...
#  T distributions
# dt(x, df): Probability Density Function (PDF) - height of curve.
# pt(q, df): Cumulative Distribution Function (CDF) - area under curve.
# qt(p, df): Quantile Function - inverse CDF.
# rt(n, df): Random Generation - random numbers.

# CL 96.5% to quantile: (n = 33)
